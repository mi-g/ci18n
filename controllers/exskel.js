...
function GoogleAnalytics() {
	if(config.gaTrackingCode) {
		var parts = [];
		parts.push("<script>");
		parts.push("  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){");
		parts.push("  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),");
		parts.push("m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)");
		parts.push("})(window,document,'script','//www.google-analytics.com/analytics.js','ga');");
